...
const UserProfile = () => {
  ...
  return (
    <>
      ...
      <div className="w-[600px]  h-[500px] border overflow-auto  p-8 bg-white shadow-lg rounded-lg transform transition duration-500 ">
        {user ? (
          <div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-4">
                {['name', 'email', 'ContactNumber' , 'Country' , 'PostCode' , 'street', 'city', 'state', 'zip'].map((field, index) => (
