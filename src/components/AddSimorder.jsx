...
const OrdersPage = () => {
  ...
  return (
    <>
      ...
      <div className="h-screen overflow-auto p-8 bg-gradient-to-br from-gray-100 via-gray-200 to-gray-300">
        ...
        {isLoading ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredOrders.map((order) => (
              ...
              >
                <h2 className="text-[1rem] font-bold text-gray-800 mb-2">
                  Order ID: <span className="text-xs">{order._id}</span>
                </h2>
