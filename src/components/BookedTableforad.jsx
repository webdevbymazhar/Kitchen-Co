      ...
      <table className="min-w-full bg-white border border-gray-300">
        <thead>
          <tr>
            ...
            <th className="py-2 border-b">Table</th>
            <th className="py-2 border-b">Seats</th>
        ...
        <tbody>
          {reservations.map((reservation) => (
            <tr key={reservation._id} className="text-center">
              ...
              <td className="py-2 border-b">{reservation.type}</td>
              <td className="py-2 border-b">{reservation.table}</td>
              <td className="py-2 border-b">{reservation.seats}</td>
              <td className="py-2 border-b">{reservation.status}</td>
            </tr>
          ))}
        </tbody>
      </table>
